...
const MenuOptions = (props: Props) => {
  ...
  return (
    ...
    justify-between flex items-center flex-col gap-10 py-6
    px-2"
    >
      <div
      ...
      >
        <Link className="flex font-bold flex-row" href="/">
          <p className="text-1xl font-bold">Fu</p>
          <Image
            src="/fuzzieLogo.png"
            width={10}
            height={10}
            ...
            className="shadow-sm"
          />
          <p className="text-1xl font-bold">zie</p>
        </Link>
        <TooltipProvider>
        ...
        flex-col gap-9 dark:bg-[#353346]/30 py-4 px-2 
        ...
        >
          ...
          >
            ...
            <div
              className="border-l-2 border-muted-foreground/50 h-6
